...
const ProfitPanel: React.FC<ProfitPanelProps> = ({
  opportunity,
  balances,
  onClose,
}) => {
  ...
  const quoteAssetBalance = buyExchangeBalances.find(
    (b) => b.asset === "USD" || b.asset === "USDT" || b.asset === "USDC",
  );
  ...
  const baseAssetBalance = sellExchangeBalances.find(
    (b) => b.asset === opportunity.asset,
  );
  ...
  const buyFeeAmount = investmentAmount * opportunity.buyFee;
  const sellFeeAmount =
    (investmentAmount +
      (investmentAmount * (opportunity.sellPrice - opportunity.buyPrice)) /
  ...
  const grossProfit =
    investmentAmount *
    ((opportunity.sellPrice - opportunity.buyPrice) / opportunity.buyPrice);
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div
        className={`fixed top-0 right-0 h-full w-full md:w-[480px] bg-[#0f172a]/95 backdrop-blur-xl border-l border-white/10 shadow-2xl z-50 transform transition-transform duration-300 ease-out ${
            ...
            <div>
              <div className="flex justify-between items-center mb-3">
                ...
                <div className="text-xs text-gray-500">
                  ...
                  <span
                    className={
                      availableUsd > 0 ? "text-primary-400" : "text-red-400"
                    }
                  >
                    $
                    {availableUsd.toLocaleString(undefined, {
              ...
              <div className="mt-2 space-y-1">
                ...
                {isOverAssetBalance && (
                  <p className="text-red-400 text-xs flex items-center gap-1">
                    ...
                    Insufficient {opportunity.asset} on{" "}
                    {opportunity.sellExchange} (Available:{" "}
                    {availableAsset.toFixed(4)})
                  </p>
                )}
              </div>
            </div>
          ...
          <div className="glass rounded-2xl p-6 border border-white/10 relative overflow-hidden group">
            ...
            <div className="relative space-y-4">
              ...
              <div className="flex justify-between items-center text-red-400/80 text-sm">
                <span>
                  Total Fees (
                  {((opportunity.buyFee + opportunity.sellFee) * 100).toFixed(
                    2,
                  )}
                  %)
                </span>
            ...
            <div className="relative pl-8 border-l-2 border-white/10 space-y-8">
              ...
              <div className="relative">
                ...
                <div className="glass p-4 rounded-xl">
                  ...
                  <div className="flex justify-between text-xs text-gray-500">
                    <span>Fee: {(opportunity.buyFee * 100).toFixed(2)}%</span>
              ...
              <div className="relative">
                ...
                <div className="glass p-4 rounded-xl">
                  ...
                  <div className="flex justify-between text-xs text-gray-500">
                    <span>Fee: {(opportunity.sellFee * 100).toFixed(2)}%</span>
